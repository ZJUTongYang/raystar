...
TEST_F(IntegrationTestFixture, DynamicParametersAreDescribedAndUpdatedAtomically) {
  ...
  auto initial_future = parameter_client->get_parameters(
    {"max_k", "occupied_threshold", "path_visualization_republish_period_ms"});
  ...
  auto below_threshold_response =
    callService(executor, service_client, makeVerticalBarrierRequest(49));
  ...
  auto at_threshold_response =
    callService(executor, service_client, makeVerticalBarrierRequest(50));
