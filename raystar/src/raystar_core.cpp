...
bool addCertifiedSegment(ConservativeBinary64PathLength& certificate,
                         const Point2d& first,
...
bool validateSearchObjective(const SearchObjective& objective,
                             const PlanningLimits& limits,
                             std::string& error) {
...
bool validateMultiGoalPlanRequest(const GridMap& grid_map,
                                  const PlanEndpoint& start,
